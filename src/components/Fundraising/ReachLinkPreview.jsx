    ...
    switch (activeTab) {
      ...
      case 'BRIEF':
        ...
        <div className="text-center mb-4">
          <h1 className="text-xl md:text-2xl font-bold mb-1">OCTARTECH PRIVATE LIMITED</h1>
          <p className="text-sm md:text-base text-gray-400 mb-2">Founded on JULY 2025</p>
          <div className="flex justify-center space-x-2 text-sm md:text-base">
            <a href="#" className="text-blue-400 hover:underline">Website</a>
        ...
        <div className="mb-4 text-center">
          ...
          <p className="text-lg md:text-xl font-bold">VERTX AI</p>
        </div>

        {/* Description Section */}
        <div className="mb-4 text-center">
          <h2 className="text-lg md:text-xl font-semibold uppercase tracking-wider text-gray-400 mb-2">Description</h2>
          <p className="text-lg md:text-xl font-medium">End to end AI Fundraising Suite</p>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-y-3 gap-x-2  text-center">
          <div>
            <h3 className="text-sm md:text-base font-semibold uppercase tracking-wider text-gray-400 mb-1">Sectors</h3>
            <p className="text-base md:text-lg font-medium">AI, Generative Tech/AI, FinTech</p>
          </div>
          <div>
            <h3 className="text-sm md:text-base font-semibold uppercase tracking-wider text-gray-400 mb-1">Stage</h3>
            <p className="text-base md:text-lg font-medium">Pre-Revenue</p>
          </div>
          <div>
            <h3 className="text-sm md:text-base font-semibold uppercase tracking-wider text-gray-400 mb-1">Category</h3>
            <p className="text-base md:text-lg font-medium">B2B, B2C, B2B2C</p>
          </div>
          <div>
            <h3 className="text-sm md:text-base font-semibold uppercase tracking-wider text-gray-400 mb-1">Model</h3>
            <p className="text-base md:text-lg font-medium">SaaS</p>
          </div>
          <div>
            <h3 className="text-sm md:text-base font-semibold uppercase tracking-wider text-gray-400 mb-1">HQ</h3>
            <p className="text-base md:text-lg font-medium">India</p>
          </div>
        </div>
        ...
        <div className="text-center mb-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Team Member 1 */}
            <div>
              <p className="text-lg md:text-xl font-bold">Praneeth Kumar</p>
              <p className="text-base md:text-lg text-gray-300 mb-2">CEO</p>
              <a href="#" className="text-blue-400 hover:underline text-sm md:text-base">LinkedIn</a>
            </div>
            {/* Team Member 2 */}
            <div>
              <p className="text-lg md:text-xl font-bold">Surya Prakash</p>
              <p className="text-base md:text-lg text-gray-300 mb-2">CTO</p>
              <a href="#" className="text-blue-400 hover:underline text-sm md:text-base">LinkedIn</a>
            </div>
            {/* Team Member 3 */}
            <div>
              <p className="text-lg md:text-xl font-bold">Tharan PS</p>
              <p className="text-base md:text-lg text-gray-300 mb-2">CMO</p>
              <a href="#" className="text-blue-400 hover:underline text-sm md:text-base">LinkedIn</a>
            </div>
          </div>
        </div>
