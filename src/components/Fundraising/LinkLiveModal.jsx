      ...
      >
        ...
        <div className="bg-black/80 p-4 rounded-md w-full max-w-md flex flex-col items-center justify-center space-y-4">
          ...
          <div className="flex items-center w-full bg-white/11 rounded-[0.125rem] pr-2">
            ...
            />
            {/* Copy button - you can add functionality here */}
            ...
            <button className="bg-white text-black px-4 py-2 rounded-[0.125rem] font-['Inter'] text-xs font-medium hover:bg-gray-200 transition-colors">
              Edit
            </button>
          </div>
        </div>
