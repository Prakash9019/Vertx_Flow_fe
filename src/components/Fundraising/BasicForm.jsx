    ...
    <div>
      ...
      <div className="relative">
        ...
        <input
          ...
          className={`w-full h-9 bg-white/11 outline-none rounded-[0.125rem] pl-8 pr-4 py-2 font-['Inter'] text-xs font-normal placeholder:text-[#656565] placeholder:font-['Inter'] placeholder:text-xs ${
            focusedInput === field ? 'text-white' : 'text-[#656565]'
          }`}
          placeholder={placeholder}
        />
