            ...
            <div className="space-y-2">
              {cofounders.map((email, index) => (
                <input
                  ...
                  className="w-full py-1 rounded-md px-2 border border-gray-700 text-white bg-black focus:ring-purple-500 focus:border-purple-500" // Added bg-black and focus styles for consistency
                  disabled={isInviting}
                />
              ))}
