...
const RevenueStatus = () => {
  ...
  const handleRevenueSelect = (option) => {
                      ...
                      {currentRevenue ? (
                        ...
                        <>                      
                          <div 
                            ...
                            className={`w-full max-w-[20rem] h-[2.439rem] border border-white/13 rounded-sm flex items-center justify-between px-4 box-border ${
                              isLoading 
                                ? 'bg-[#1a1a1a] cursor-not-allowed opacity-60' 
                                : 'bg-[#0F0E16] cursor-pointer'
                            }`}
                          >
                            <span className={`font-inter font-normal text-xs leading-[0.9375rem] ${
                              isLoading ? 'text-gray-500' : 'text-[#656565]'
                            }`}>
                              Select
                            </span>
                            <svg 
